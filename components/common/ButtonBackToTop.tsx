      ...
      {buttonBackToTop ? (
        <div>
          <svg
            ...
            height='30'
            viewBox='0 0 30 30'
            className='to-top-button fixed bottom-8 right-8 z-10 h-[50px] w-[50px] rotate-90 cursor-pointer fill-current opacity-30 hover:opacity-20 active:opacity-50 sm:h-[30px] sm:w-[30px] animate-fade-in'
          >
