...
const BackToTopButton: React.FC = () => {
  ...
  return (
    <div
      className="fixed left-[50px] bottom-[50px] z-20 cursor-pointer"
      onClick={scrollUp}
    >
      {backToTopButton && (
        <div>
          <svg
            ...
            height="30"
            viewBox="0 0 30 30"
            className="fill-current to-top-button z-10 fixed bottom-8 right-8 w-[50px] h-[50px] sm:w-[30px] sm:h-[30px] opacity-30 rotate-90 hover:opacity-20 active:opacity-50 cursor-pointer"
          >
