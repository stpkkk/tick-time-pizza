  ...
  return (
    ...
    >
      <div className="flex-1 mb-5">
        <div className="flex flex-col gap-4">
          <Image
            ...
            className={`${
              isHover && "opacity-50"
            } self-center fill-red-500 text-red-500`}
          />
      ...
      <div className="flex flex_between">
        ...
        <button className="bg-yellowButton text-primary font-bold py-2 px-4 rounded-2xl text-xs flex items-center justify-center uppercase h-[45px] w-auto hover:bg-yellowButtonHover">
          Выбрать
        </button>
      </div>
      <button
